...
const Sidebar = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-blue-50 to-cyan-50 border-r border-blue-100 flex flex-col overflow-x-hidden">
      {/* Logo/Header */}
      <div className="p-3 sm:p-4 border-b border-blue-100 bg-gradient-to-r from-blue-100 to-cyan-50 flex-shrink-0">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-600 to-cyan-400 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg">
      ...
      {/* Navigation */}
      <div className="flex-1 py-2 sm:py-4 overflow-y-auto overflow-x-hidden bg-transparent">
      ...
      {/* Footer */}
      <div className="p-3 sm:p-4 border-t border-blue-100 bg-blue-50 flex-shrink-0">
        {/* User Info */}
        {/* {user && (
        ...
        <div className="text-center text-xs text-gray-400">
          <div className="hidden sm:block">
            ...
            <p className="text-gray-500">© 2025 Shopsnap Admin v1.0.0</p>
          </div>
