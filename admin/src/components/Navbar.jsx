...
const Navbar = () => {
  ...
  return (
    <header className="border-b border-blue-100 w-full sticky top-0 left-0 z-40 bg-gradient-to-r from-blue-50 to-cyan-50 shadow-md">
      <div className="py-2.5 flex items-center justify-between px-4 bg-transparent">
        {/* Logo Section */}
        <Link to={"/"} className="flex items-center gap-3 group">
          ...
          <div className="hidden sm:block">
            <p className="text-xs uppercase font-bold tracking-wide text-cyan-700">
              Admin Panel
            </p>
            <p className="text-xs text-blue-400">Dashboard v1.0</p>
          </div>
        </Link>
