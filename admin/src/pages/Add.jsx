          ...
          >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                <div className="lg:col-span-2">
                  ...
                  <Input
                    ...
                    required
                    className="mt-1 text-gray-900 placeholder-gray-600"
                ...
                <div className="lg:col-span-2">
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="mt-1 w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-gray-900 placeholder-gray-600"
                ...
                <div>
                  ...
                  {brands.length > 0 ? (
                    <select
                      ...
                      className="mt-1 w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"
                    >
                      <option value="">
                ...
                <div>
                  <Label htmlFor="_type" className="text-gray-900 font-semibold">Product Type</Label>
                  <select
                    name="_type"
            ...
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                <div className="flex flex-col">
                  <Label htmlFor="price" className="text-gray-900 font-semibold">Price *</Label>
                  <Input
                    type="number"
                    step="0.01"
                    min="0"
                ...
                <div className="flex flex-col">
                  <Label htmlFor="discountedPercentage" className="text-gray-900 font-semibold">
                    Discount Percentage
                  </Label>
                  <Input
                    type="number"
            ...
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div>
                  <Label htmlFor="isAvailable" className="text-gray-900 font-semibold">Availability</Label>
                  <select
                    name="isAvailable"
                ...
                <div>
                  <Label htmlFor="offer" className="text-gray-900 font-semibold">Special Offer</Label>
                  <select
                    name="offer"
                ...
                <div>
                  <Label htmlFor="badge" className="text-gray-900 font-semibold">Show Badge</Label>
                  <select
                    name="badge"
